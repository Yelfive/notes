...
var Key2Function = [
    ...
    {keys: ['BackQuote'], action: 'BackQuote', description: 'To create inline code area', type: 'builtin'},
    {keys: ['Tab'], action: 'tab', description: 'Insert a tab(4 spaces by default)'},
    {keys: ['Shift', 'Tab'], action: 'tabReduce', description: 'Insert a tab(4 spaces by default)'}
];