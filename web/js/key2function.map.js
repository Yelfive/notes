...
var Key2Function = [
    ...
    {keys: ['Shift', 'Enter'], action: 'createNewLine', description: 'Create a new line below the caret'},
    {keys: ['Control', 'Enter'], action: 'createNewLine2Go', description: 'Create a new line below the caret, and move the caret to new line'},
